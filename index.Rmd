...
I am currently a Research Engineer, since December 2023, at CNRS Sorbonne Université (LIP6) within the [TORI project](https://erc-tori.github.io/). 
...
<div class="container">
    ...
    <div class="text">
      ...
      <p>Mathieu Pont</p>
      <p><b>PhD in Computer Science (2023)</b></p>
      <p><i>Committee:</i> Gabriel Peyré (president of the jury), David Coeurjolly (reviewer), Vijay Natarajan (reviewer), Elsa Cazelles, Stanley Durrleman, Katharine Turner, Julien Tierny (advisor)</p>
...
<div class="container">
    ...
    <div class="text">
      ...
      <p><a href=https://arxiv.org/pdf/2307.02509.pdf>Paper</a> - <a href=https://github.com/MatPont/MT-WAE>Code</a></p>
    </div>
</div>
```
...
- Dec. 1st, PhD Defense -- "Analysis of Ensembles of Topological Descriptors"
