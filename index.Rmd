...
```{r out.width='21.5%', out.extra='style="float:right; padding:0px; margin-top: 14.5px; margin-right:5.5px; margin-left:5px"', echo=FALSE}
knitr::include_graphics("img/PONT_photo.jpg")
```

<div style="background-color:rgb(180, 190, 195); text-align: left; color:rgb(44, 51, 51); width:47.9em; max-width:47.9em; height:14em; max-height:14em">
<br /><br />
...
<style>
  ...
  .nav-pills>li>a:hover, .nav-pills>li>a:focus, .nav-pills>li.active>a, .nav-pills>li.active>a:hover, .nav-pills>li.active>a:focus{
     color: rgb(44, 51, 51) !important;
     background-color: rgb(180, 190, 195);
     }
</style>
