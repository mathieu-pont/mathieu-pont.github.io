...
<span style="margin-left: 110px;">Kaiserslautern-Landau University</span>
...
I currently have a post-doctoral position, since October 2024, at the Kaiserslautern-Landau University in the [Scientific Visualization Lab](https://vis.cs.rptu.de/), working with [Christoph Garth](https://vis.cs.rptu.de/team/garth/).

Before that, I had a temporary post-doctoral position, starting December 2023, at CNRS Sorbonne Université (LIP6) within the [TORI project](https://erc-tori.github.io/) with [Julien Tierny](https://julien-tierny.github.io/). 
